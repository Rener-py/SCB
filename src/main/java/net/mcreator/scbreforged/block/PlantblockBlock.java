...
public class PlantblockBlock extends FallingBlock {
	public PlantblockBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_CYAN).sound(SoundType.CAVE_VINES).strength(0f, 2000f).lightLevel(s -> 3).noCollission().noOcclusion().hasPostProcess((bs, br, bp) -> true)
	...
	public void animateTick(BlockState blockstate, Level world, BlockPos pos, RandomSource random) {
		...
		int y = pos.getY();
		int z = pos.getZ();
		PartickleupdateProcedure.execute(world, x, y, z);
	}
